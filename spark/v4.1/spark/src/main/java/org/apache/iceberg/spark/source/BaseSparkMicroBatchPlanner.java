...
/**
 * Base implementation of {@link SparkMicroBatchPlanner} that contains the core planning logic
 * originally from SparkMicroBatchStream.
 *
 * <p>This class provides synchronous manifest scanning and can be extended to provide alternative
 * planning strategies (e.g., asynchronous background processing).
 */
class BaseSparkMicroBatchPlanner implements SparkMicroBatchPlanner {
  private static final Logger LOG = LoggerFactory.getLogger(BaseSparkMicroBatchPlanner.class);

  private final Table table;
  private final SparkReadConf readConf;
  protected StreamingOffset lastOffsetForTriggerAvailableNow;
  ...
  @Override
  public void stop() {
    // No resources to clean up in the base synchronous implementation
  }
  ...
  protected static int getMaxRows(ReadLimit readLimit) {
