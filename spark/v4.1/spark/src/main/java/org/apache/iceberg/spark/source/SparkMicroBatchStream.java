...
/**
 * Spark streaming source that reads data from Iceberg tables in micro-batches.
 *
 * <p>This class delegates the planning logic to {@link SparkMicroBatchPlanner} implementations,
 * which can be either synchronous or asynchronous based on configuration.
 */
